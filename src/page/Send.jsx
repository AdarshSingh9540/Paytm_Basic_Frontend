                ...
                <div className="border h-min text-card-foreground max-w-md p-4 space-y-8 w-96 bg-white shadow-lg rounded-lg">
                    ...
                    <div className="p-6">
                        ...
                        <div className="space-y-4">
                            ...
                            {error && <p className="text-red-500 text-sm font-serif font-semibold">{error}</p>}
                            {success && <p className="text-green-500 text-sm font-serif font-semibold">Payment successful!</p>}
                        </div>
                    </div>
                </div>
            </div>
